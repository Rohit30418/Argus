...
function body(config, prompt, maxTokens = config.maxTokens) {
  ...
  return {
    model: config.model,
    messages: [
      { role: 'system', content: 'You are ARGUS, an evidence-bound senior web QA investigator. Never invent observations, code locations, causes, user impact, or tests.' },
